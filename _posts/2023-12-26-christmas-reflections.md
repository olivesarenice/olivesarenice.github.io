...
`IF (on public transport) AND (travel > 1 hours) THEN (listen to the How I Built This Podcast)`
`IF (have > 2 hours free) AND (no other work to do at night) THEN (start a coding project)`

Other tech-related systems:
...
* I need to create this template before start of year and fill it up for my first review session.
...
- Curate YT account to only allow educational channels - DONE
- Set up personal blog for quick writing and logging thoughts - DONE
- Curate personal news feed like Feedly to sources of interest - NOT DONE
- Prepare to-read books inside Kobo - DONE
- Prepare list of want-to-watch movies to prevent scrolling - PENDING
What it accomplishes:
...
System 3. Non-negotiable nutrition intakes
What it involves:
